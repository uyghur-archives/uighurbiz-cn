...
ZoneAD_1.ZoneID      = 1;
ZoneAD_1.ZoneWidth   = 280;
ZoneAD_1.ZoneHeight  = 51;
ZoneAD_1.ShowType    = 1;
...
objAD.ADType         = 1;
objAD.ADName         = "论坛连接";
objAD.ImgUrl         = "/AD/UploadADPic/200602/20060208041449622.jpg";
objAD.ImgWidth       = 0;
objAD.ImgHeight      = 0;
objAD.FlashWmode     = 0;
objAD.ADIntro        = "论坛连接";
objAD.LinkUrl        = "http://www.uighurbiz.cn/bbs/";
objAD.LinkTarget     = 1;
objAD.LinkAlt        = "欢迎访问维吾尔茶社";
objAD.Priority       = 1;
objAD.CountView      = 0;
objAD.CountClick     = 0;
objAD.InstallDir     = "/";
